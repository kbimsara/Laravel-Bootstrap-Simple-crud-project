            ...
            <div class="col-4">
                <form method="post" action="/sub">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nm" name="nm" placeholder="Enter" value="{{$user->stName}}">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary" name="action" value="delete">Delete me</button>
                </form>
            </div>
        </div>
    </div>
